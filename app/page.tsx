    ...
    <main className="min-h-screen bg-gray-900 text-white">
      <nav className="bg-gray-950 border-b border-gray-800 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-4 text-sm">
          ...
          <a href="#" className="bg-orange-500 text-black px-4 py-2 rounded-lg font-bold">List Property</a>
        </div>
      </nav>
      <section className="text-center py-24 px-6 bg-gray-950">
        ...
        <p className="text-gray-400 text-xl mb-8">South Africa's smartest AI-powered property platform — 45% cheaper than the competition</p>
        <div className="bg-gray-800 rounded-2xl p-3 max-w-2xl mx-auto flex gap-2">
          <button className="bg-orange-500 text-black px-5 py-2 rounded-lg font-bold">Buy</button>
          <button className="text-gray-400 px-5 py-2 rounded-lg">Rent</button>
      ...
      <section className="px-6 py-16 max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="bg-gray-800 rounded-xl border border-gray-700 hover:border-orange-500 transition-all cursor-pointer">
              <div className="h-48 bg-gray-700 flex items-center justify-center text-5xl rounded-t-xl">🏡</div>
              <div className="p-4">
