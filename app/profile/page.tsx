        ...
        <div className="bg-white rounded-2xl border border-stone-300 p-6 space-y-4">
          ...
          <div>
            ...
            <input value={newPassword} onChange={e => setNewPassword(e.target.value)}
              className="w-full bg-amber-50 text-stone-800 rounded-lg px-4 py-3 outline-none border border-stone-300 focus:border-orange-500 mb-3"
          ...
          {accountType === 'agent' && (
            <div className="bg-amber-50 rounded-xl p-4 border border-stone-300">
