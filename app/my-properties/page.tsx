...
export default function MyPropertiesPage() {
  ...
  const getViewsLabel = (views: number) => {
    ...
    return { label: `${views} views`, color: 'text-stone-500' }
  }
      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="mb-8 flex justify-between items-start">
          <div>
            ...
            <p className="text-stone-500 mt-1 text-sm">{user?.email}</p>
          </div>
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          <a href="/saved" className="bg-white rounded-xl p-4 border border-stone-300 text-center hover:border-orange-500 transition cursor-pointer block">
            <p className="text-3xl font-bold text-orange-500">{savedProperties.length}</p>
            <p className="text-stone-500 text-sm mt-1">Saved Properties</p>
          ...
          <div onClick={() => document.getElementById('viewings')?.scrollIntoView({behavior: 'smooth'})}
            className="bg-white rounded-xl p-4 border border-stone-300 text-center hover:border-green-500 transition cursor-pointer">
          ...
          <div onClick={() => document.getElementById('viewings')?.scrollIntoView({behavior: 'smooth'})}
            className="bg-white rounded-xl p-4 border border-stone-300 text-center hover:border-yellow-500 transition cursor-pointer">
        ...
        <div className="bg-gradient-to-r from-orange-900 to-gray-800 rounded-2xl p-6 border border-orange-700 mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-stone-700 text-sm">Chat with our AI Concierge — just describe what you want</p>
            </div>
          ...
          <div className="mb-8" id="viewings">
            ...
            <div className="space-y-3">
              {bookings.map(booking => (
                <div key={booking.id} className="bg-white rounded-xl border border-stone-300 p-4 flex gap-4 items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-stone-500 text-sm">📍 {booking.properties?.suburb}, {booking.properties?.city}</p>
        ...
        <div className="bg-white border border-stone-300 rounded-2xl p-6 mb-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-stone-700 text-sm">Get quotes from verified removal companies, cleaners, attorneys and more</p>
            </div>
            <a href="/moving" className="bg-stone-100 hover:bg-stone-200 text-stone-900 font-bold px-5 py-2.5 rounded-xl transition flex-shrink-0 text-sm">
              Get Quotes →
            </a>
          </div>
        </div>
        ...
        <div>
          ...
          {savedProperties.length === 0 ? (
            <div className="bg-white rounded-2xl border border-stone-300 p-12 text-center">
              <p className="text-4xl mb-3">🏡</p>
              <p className="text-stone-700 font-semibold mb-1">No saved properties yet</p>
              <p className="text-stone-400 text-sm mb-4">Use AI Search to find properties and save the ones you love</p>
                ...
                return (
                  <div key={property.id} className="bg-white rounded-2xl border border-stone-300 overflow-hidden">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-stone-500 text-xs">📍 {property.suburb}, {property.city}</p>
                      ...
                      <div className="flex gap-2 mt-3">
                        ...
                        <button onClick={() => unsave(property.id)}
                          className="flex-1 border border-stone-300 hover:border-red-500 hover:text-red-400 text-stone-500 text-xs py-1.5 rounded-lg">
                          Remove
                        </button>
                      </div>
                    </div>
