  ...
  return (
    <main className="min-h-screen bg-stone-50 text-stone-900">
      <nav className="bg-stone-100 border-b border-stone-200 px-6 py-4 flex justify-between items-center">
        ...
        <Link href="/supplier/register" className="text-stone-500 hover:text-stone-900 text-sm">Register as a Supplier →</Link>
      </nav>
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-stone-500 text-sm mb-8">These terms govern your participation as a service provider on the PropertyAIgency platform. By registering as a supplier you agree to these terms in full.</p>
        ...
        <div className="space-y-8 text-stone-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">3. Application & Approval</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">5. Free Trial</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">6. Subscription Fees</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">7. Per-Lead Fees</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">8. What Counts as a Lead</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">9. Invoicing & Payment</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">10. Lead Limits & Pausing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">11. Client Address Privacy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">12. Quality Standards</h2>
            <ul className="list-disc list-inside space-y-1 text-stone-500">
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">13. Complaints & Removal</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">14. POPIA & Data Protection</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">15. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">16. Governing Law</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">17. Contact</h2>
