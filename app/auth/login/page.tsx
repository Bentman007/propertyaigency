...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      <div className="bg-gray-800 rounded-2xl p-8 w-full max-w-w-md border border-gray-700">
        ...
        <p className="text-center text-gray-400 mt-6 text-sm">
          ...
          <a href="/auth/register" className="text-orange-500 hover:underline">Register here</a>
        </p>
      </div>
    </main>
  )
