  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-stone-100 to-stone-50 text-stone-900">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-stone-500 text-sm mb-8">PropertyAIgency (Pty) Ltd is committed to protecting your personal information in accordance with the Protection of Personal Information Act 4 of 2013 (POPIA). This policy explains what we collect, why we collect it, how we use it and your rights.</p>
        ...
        <div className="space-y-8 text-stone-700 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">4. AI and Data Processing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">5. Address Privacy & Supplier Data Sharing</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">6. Data Sharing With Third Parties</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">7. Email Communications</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">8. Data Security</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">9. Your Rights Under POPIA</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">10. Cookies and Tracking</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">11. Push Notifications</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">12. Data Retention</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">13. Children</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">14. Changes to This Policy</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-stone-900 mb-3">15. Contact & Complaints</h2>
