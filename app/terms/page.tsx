  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <p className="text-gray-400 text-sm mb-8">These terms apply to all users of the PropertyAIgency platform including buyers, renters, estate agents, private sellers and service providers.</p>
        ...
        <div className="space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">7. Viewing Bookings</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">8. Marketplace & Service Providers</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">9. Fees and Payments</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-white mb-3">10. Prohibited Conduct</h2>
