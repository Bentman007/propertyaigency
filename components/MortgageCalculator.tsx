  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden">
      <button onClick={() => setOpen(!open)}
        className="w-full px-5 py-4 flex justify-between items-center hover:bg-gray-750 transition">
        ...
        <div className="px-5 pb-5 space-y-4 border-t border-gray-700 pt-4">
          ...
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-gray-400 text-xs">Deposit</label>
          ...
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-gray-400 text-xs">Interest Rate</label>
          ...
          <div>
            <div className="flex justify-between mb-1">
              <label className="text-gray-400 text-xs">Loan Term</label>
          ...
          <div className="bg-gray-700 rounded-xl p-4 space-y-2">
            ...
            <div className="flex justify-between">
              <span className="text-gray-400 text-sm">Monthly repayment</span>
            ...
            <div className="border-t border-gray-600 pt-2 flex justify-between">
              <span className="text-gray-400 text-sm">Est. transfer + bond costs</span>
